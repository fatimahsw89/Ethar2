...
public class AlDammam extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Dammam Medical Complex", "King Fahad Specialist Hospital", "Imam abdulrahmman bin Faisal Hospital" };
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlDammam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
