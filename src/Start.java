...
public class Start extends javax.swing.JFrame {
    ...
    public Start() {
        initComponents();
        ImageIcon image = new ImageIcon(getClass().getResource("logo-1.png"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("{و احسنوا ان الله يحب المحسنين }");
        ...
        myButton1.setFont(new java.awt.Font("Serif", 1, 14)); // NOI18N
